...
<script>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <li class=" drop-down">
      ...
      <ul >
              <li><a href="dashboard/profile.php"><i class='bx bx-user'></i> Profile</a></li>
              ...
              <li><a href="dashboard/order-history.php"><i class='bx bx-transfer' ></i> Transactions</a></li>
              <li><a href="dashboard/logout.php"><i class='bx bx-log-out' ></i> Logout</a></li>
            </ul>
      </li>
    </ul>
    </div>
